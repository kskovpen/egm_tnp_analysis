#
# Tuples used were produced with https://github.com/UAEDF-tomc/EgammaAnalysis-TnPTreeProducer/tree/01a26990b822d50f82eca52a45ff3f225973b465
#
...
# flag to be Tested
flags = {
    'passingEtEle32WPTight' : '(passL1TEtEle32WPTight == 1)'
    }
baseOutDir = 'results/2018/tnpEleTrig/Ele32/' + type
...
cutBase = 'tag_sc_et > 35 && abs(tag_sc_eta) < 2.1 && passL1TEle32WPTight==1'
